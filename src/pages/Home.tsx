...
import { FbLogo, GoogleAdsLogo, LinkedInLogo } from "@/assets/logos";
...
const Home = () => {
  ...
  return (
    <>
      <section
        className="container mx-auto md:h-[912px] h-[710px] p-4 relative rounded-[35px] border border-[#E6E6E6] mt-5 overflow-hidden">
        <DotBackground/>
      ...
      <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-center mb-4 text-zinc-800 dark:text-zinc-100">Why Choose Otomatika</h2>
