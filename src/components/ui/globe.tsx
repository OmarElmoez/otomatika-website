...
export function Globe({ globeConfig, data }: WorldProps) {
  ...
  // Build material when a globe is initialized or when relevant props change
  useEffect(() => {
  ...
  // Build data when a globe is initialized or when data changes
  useEffect(() => {
